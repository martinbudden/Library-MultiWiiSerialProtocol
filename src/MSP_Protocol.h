...
#define MSP_API_VERSION_MAJOR               1  // increment when major changes are made
#define MSP_API_VERSION_MINOR               47 // increment after a release, to set the version for all changes to go into the following release (if no changes to MSP are made between the releases, this can be reverted before the release)

#define MSP_API_VERSION_LENGTH              2
...
#define MSP_RAW_GPS              106    //out message         fix, number of satellites, lat, lon, alt, speed, ground course
...
#define MSP_VALIDATE_SIMPLIFIED_TUNING    145    //out message    Returns an array of true/false showing which simplified tuning groups are matching with value and which are not

#define MSP_SET_RAW_RC           200    //in message          8 rc chan
#define MSP_SET_RAW_GPS          201    //in message          fix, number of satellites, lat, lon, alt, speed
