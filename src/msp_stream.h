...
public:
    ...
    MspBase::postProcessFnPtr process_received_command(msp_stream_packet_with_header_t* pwh);
    ...
    bool put_char(uint8_t c, msp_stream_packet_with_header_t* pwh);

public: // for testing
    msp_const_packet_t process_in_buf();
