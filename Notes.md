    ...
    calls _msp_stream.put_char
        calls process_received_command
            calls _msp_base.process_command
                calls process_write_command (gets parameters and writes dst) returns MSP_RESULT_ACK or MSP_RESULT_CMD_UNKNOWN
                or process_read_command (reads src and sets parameters) returns MSP_RESULT_ERROR or MSP_RESULT_ACK
