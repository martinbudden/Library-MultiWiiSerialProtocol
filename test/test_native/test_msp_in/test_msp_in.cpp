...
public:
    virtual result_e processSetCommand(int16_t cmdMSP, const StreamBufReader& src, descriptor_t srcDesc, postProcessFnPtr* postProcessFn) override;
public:
...
*/
MSP_Base::result_e MSP_Test::processSetCommand(int16_t cmdMSP, const StreamBufReader& src, descriptor_t srcDesc, postProcessFnPtr* postProcessFn) // NOLINT(readability-convert-member-functions-to-static)
{
    (void)srcDesc;
    (void)postProcessFn;
