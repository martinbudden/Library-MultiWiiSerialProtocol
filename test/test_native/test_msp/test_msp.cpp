...
void test_MSP_BASE_API_VERSION()
{
    static MSP_Base msp;
    static MSP_Stream mspStream(msp);
...
class MSP_Serial_MSP_BASE_API_VERSION : public MSP_SerialBase {
public:
    virtual ~MSP_Serial_MSP_BASE_API_VERSION() = default;
    MSP_Serial_MSP_BASE_API_VERSION() = default;
public:
    // MSP_Serial_MSP_BASE_API_VERSION is not copyable or moveable
    MSP_Serial_MSP_BASE_API_VERSION(const MSP_Serial_MSP_BASE_API_VERSION&) = delete;
    MSP_Serial_MSP_BASE_API_VERSION& operator=(const MSP_Serial_MSP_BASE_API_VERSION&) = delete;
    MSP_Serial_MSP_BASE_API_VERSION(MSP_Serial_MSP_BASE_API_VERSION&&) = delete;
    MSP_Serial_MSP_BASE_API_VERSION& operator=(MSP_Serial_MSP_BASE_API_VERSION&&) = delete;
private:
...
int MSP_Serial_MSP_BASE_API_VERSION::sendFrame(const uint8_t* hdr, int hdrLen, const uint8_t* data, int dataLen, const uint8_t* crc, int crcLen)
{
    ...
    TEST_ASSERT_EQUAL(44, *crc);

    return 0;
}

void MSP_Serial_MSP_BASE_API_VERSION::processInput()
{
}

void test_MSP_BASE_API_VERSION_putchar()
{
    static MSP_Base msp;
    static MSP_Serial_MSP_BASE_API_VERSION mspSerial;
...
void test_MSP_BASE_API_VERSION_putchar_array_stream()
{
    static MSP_Base msp;
    static MSP_Stream mspStream(msp);
...
void test_MSP_BASE_API_VERSION_putchar_array_stream_no_payload()
{
    static MSP_Base msp;
    static MSP_Stream mspStream(msp);
...
void test_MSP_BASE_API_VERSION_putchar_array_stream_loop()
{
    static MSP_Base msp;
    static MSP_Stream mspStream(msp);
...
int main([[maybe_unused]] int argc, [[maybe_unused]] char **argv)
{
    ...
    RUN_TEST(test_MSP_BASE_API_VERSION);
    RUN_TEST(test_MSP_BASE_API_VERSION_putchar);
    RUN_TEST(test_MSP_BASE_API_VERSION_putchar_array_stream);
    RUN_TEST(test_MSP_BASE_API_VERSION_putchar_array_stream_no_payload);
    RUN_TEST(test_MSP_BASE_API_VERSION_putchar_array_stream_loop);
